...
export const register = async (req, res) => {
    ...
    try {
        ...
        res.cookie('token', token, { httpOnly: true, secure: true, sameSite: 'none', domain: FRONT_URL, partitioned: 'Admin', expires: expirationDate });
...
export const logout = (req, res) => {
    try {
        ...
        res.cookie('token', null, { httpOnly: true, secure: true, sameSite: 'none', domain: FRONT_URL, partitioned: 'Admin', expires: new Date(0) });
