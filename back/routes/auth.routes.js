...
import { register, login, logout, getAdmins, deleteAdmin, updateAdmin } from "../controllers/auth.controller.js";
...
router.delete('/delete-admin', adminRequired, deleteAdmin)
